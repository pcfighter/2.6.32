...
#define ACCEL_GPIO_I2C_SCL  	40 //2
#define ACCEL_GPIO_I2C_SDA  	41 //3
#define ACCEL_I2C_ADDRESS	0x38 //0x08

/*Ecompass*/
#define ECOM_GPIO_INT		18 //31
#define ECOM_GPIO_I2C_SCL	30 //107
#define ECOM_GPIO_I2C_SDA	31 //108
#define ECOM_GPIO_RST		23 //
#define ECOM_I2C_ADDRESS	0x1C //0x0F

/* lcd & backlight */
#define GPIO_LCD_BL_EN		84 //82
#define GPIO_BL_I2C_SCL		88 //88
#define GPIO_BL_I2C_SDA		89 //89
#define GPIO_LCD_VSYNC_O	97
#define GPIO_LCD_MAKER_LOW	102 //101
#define GPIO_LCD_RESET_N	101 //102
