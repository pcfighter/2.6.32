...
static int mddi_s6d05a0_pmic_backlight(int level)
{
	//struct backlight_device *bd;

	//printk(KERN_ERR "[sungwoo] bl_level : %d \n", mfd->bl_level);
	//rt9393_set_intensity(level);

	return 0;
}

/*static struct msm_panel_hitachi_pdata mddi_s6d05a0_panel_data = {
	.gpio = 101,
	.pmic_backlight = mddi_s6d05a0_pmic_backlight,
	.initialized = 1,
};

static struct platform_device mddi_s6d05a0_panel_device = {
	.name   = "mddi_s6d05a0",
	.id     = 0,
	.dev    = {
		.platform_data = &mddi_s6d05a0_panel_data,
	}
};*/
...
/*static struct rt9393_platform_data rt9393_platform_data = {
	.gpio_en = 84,
};

static struct paltform_device rt9393_platform_device = {
	.name	= "rt9393-bl",
	.id	= 0,
	.dev	= {
		.platform_data = &rt9393_platform_data,
	}
};*/
